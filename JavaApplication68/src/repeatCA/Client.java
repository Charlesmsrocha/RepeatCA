...
public class Client extends UnicastRemoteObject implements ClientInterface {
    ...
    protected Client(ServerInterface server, int clientNumber) throws RemoteException {
        this.server = server;
        ...
        System.out.print("Enter the name of the " + getClientOrdinal(clientNumber) + " client: ");
    ...
    private String getClientOrdinal(int clientNumber) {
        switch (clientNumber) {
            case 1: return "first";
            ...
            case 5: return "fifth";
            default: return clientNumber + "th";
        }
    }
    ...
    public void startGenerating() throws RemoteException {
        ...
        while (server.getTotal() < 1000000) {
            ...
            server.addNumber(randomNumber, this);
